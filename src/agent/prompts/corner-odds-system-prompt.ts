 ...
 */
export const CORNER_ODDS_SYSTEM_PROMPT = `# Corner Odds Collection
...
\`\`\`bash
curl -s "https://api.the-odds-api.com/v4/sports/{sportKey}/events/{eventId}/odds?apiKey=$THE_ODDS_API_KEY&markets=alternate_totals_corners,alternate_spreads_corners&regions=eu,us"
\`\`\`
...
3. **Pivot totals markets** — Over/Under markets should be pivoted so each row is a line and columns are bookmaker O/U pairs.
